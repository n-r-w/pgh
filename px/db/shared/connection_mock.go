...
//
//	mockgen -source connection.go -destination connection_mock.go -package shared
//
...
// MockIStartStopConnecter is a mock of IStartStopConnecter interface.
type MockIStartStopConnecter struct {
	ctrl     *gomock.Controller
	recorder *MockIStartStopConnecterMockRecorder
}

// MockIStartStopConnecterMockRecorder is the mock recorder for MockIStartStopConnecter.
type MockIStartStopConnecterMockRecorder struct {
	mock *MockIStartStopConnecter
}

// NewMockIStartStopConnecter creates a new mock instance.
func NewMockIStartStopConnecter(ctrl *gomock.Controller) *MockIStartStopConnecter {
	mock := &MockIStartStopConnecter{ctrl: ctrl}
	mock.recorder = &MockIStartStopConnecterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIStartStopConnecter) EXPECT() *MockIStartStopConnecterMockRecorder {
	return m.recorder
}

// Connection mocks base method.
func (m *MockIStartStopConnecter) Connection(ctx context.Context, opt ...ConnectionOption) IConnection {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opt {
		varargs = append(varargs, a)
...
func (mr *MockIStartStopConnecterMockRecorder) Connection(ctx any, opt ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx}, opt...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Connection", reflect.TypeOf((*MockIStartStopConnecter)(nil).Connection), varargs...)
}

// Start mocks base method.
func (m *MockIStartStopConnecter) Start(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockIStartStopConnecterMockRecorder) Start(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockIStartStopConnecter)(nil).Start), ctx)
}

// Stop mocks base method.
func (m *MockIStartStopConnecter) Stop(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockIStartStopConnecterMockRecorder) Stop(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Stop", reflect.TypeOf((*MockIStartStopConnecter)(nil).Stop), ctx)
}
