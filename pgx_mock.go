...
// Source: github.com/jackc/pgx/v5 (interfaces: BatchResults,Row,Rows,Tx)
//
// Generated by this command:
//
//	mockgen -package pgh -destination pgx_mock.go github.com/jackc/pgx/v5 BatchResults,Row,Rows,Tx
//
